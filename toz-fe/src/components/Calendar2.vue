<template>
  <div class="container">
    <button @click="previousWeekDate">Previous</button>
    <p>KWIECIEŃ 10-16</p>
    ...
    <div class="row justify-content-end">
      <div class="col-11 col-md-11 col-xl-11">
        <table class="table">
          <tr>
            <td v-for="days in dateInWeekAfternoon">
              <dayItem
                :currentDay="days.day"
                :currentMonth="days.month"
                :currentYear="days.year"
...
export default {
  ...
  methods: {
    ...
    setDayAndDateInWeekWithTwoMonths (remainingDays, periodName) { // FUNKCJA DO POPRAWY
      this.mondayToSundayDate[0] = this.mondayDate
